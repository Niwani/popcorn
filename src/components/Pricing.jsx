...
export default function Pricing() {
  return (
    <section className="px-6 py-16 ml-10">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10 items-stretch">
          <div className="border p-10 rounded-xl shadow bg-green-50 flex flex-col justify-between">
            <div className="bg-white rounded-lg p-8 inline-block mt-6">
          ...
          <div className="border p-6 rounded-xl shadow bg-blue-50 flex flex-col justify-between">
            <div className="bg-white rounded-lg p-8 inline-block mt-10">
          ...
          <div className="border p-6 rounded-xl shadow bg-pink-100 flex flex-col justify-between">
            <div className="relative rounded-lg overflow-hidden flex justify-center items-center mt-10 h-45">
